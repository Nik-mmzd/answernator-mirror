CREATE TABLE ANTISPAMCONFIGS (
    ...
    BAN_THRESHOLD     ${datatype:integer} NOT NULL,
...
CREATE INDEX SPAMVIOLATIONS_USER_ID ON SPAMVIOLATIONS (USER_ID);
CREATE INDEX SPAMVIOLATIONS_USER_ID_GUILD_ID ON SPAMVIOLATIONS (USER_ID, GUILD_ID);
