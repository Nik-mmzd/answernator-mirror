...
/**
 * Exits the process (for a supervisor to restart) when the gateway connection becomes a zombie and does
 * not recover within [RESTART_DELAY]. Deployed via `ZombieWatchdogModule`.
 */
